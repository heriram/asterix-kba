...
public class KBADataGenerator {
     ...
     */
    public class KBAStreamDocIterator implements Iterator<KBAStreamDoc> {

        Iterator<KBAStreamDoc> streamItemListIterator;

        public KBAStreamDocIterator() {
            List<KBAStreamDoc> stream_item_list = kbaReader.getStreamItemList();
    ...
    public static class KBAStreamDocReader {
        private List<KBAStreamDoc> streamItems;
        ...
        public void read() throws TException {
            streamItems = new ArrayList<KBAStreamDoc>(this.streamBufferSize);
                ...
                for (; file_index < xz_files.length; file_index++) {
                    ...
                    try {
                        while (true) {
                            ...
                            KBAStreamDoc kba_stream = new KBAStreamDoc(item, datehourdir.getName());
        ...
        public List<KBAStreamDoc> getStreamItemList() {
            return streamItems;
        }
