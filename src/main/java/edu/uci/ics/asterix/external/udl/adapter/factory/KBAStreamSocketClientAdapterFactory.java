...
import edu.uci.ics.asterix.tools.external.data.GenericSocketFeedAdapterFactory;
import edu.uci.ics.hyracks.algebricks.common.constraints.AlgebricksPartitionConstraint;
import edu.uci.ics.hyracks.algebricks.common.utils.Pair;
import edu.uci.ics.hyracks.api.context.IHyracksTaskContext;

public class KBAStreamSocketClientAdapterFactory extends StreamBasedAdapterFactory implements IFeedAdapterFactory {
    ...
    public void configure(Map<String, String> configuration, ARecordType outputType) throws Exception {
        ...
        directorySplits = directorySplitsValue.trim().split(",");
    ...
    public String getName() {
        return "kba_stream_socket_client";
    }
    ...
    //ITupleParserFactory parserFactory, IAType sourceDatatype,  IHyracksTaskContext ctx, int partition, int port, String localDir
    @Override
    public IDatasourceAdapter createAdapter(IHyracksTaskContext ctx, int partition) throws Exception {
        Pair<String, Integer> socket = genericSocketAdapterFactory.getSockets().get(partition);
        return new KBAStreamSocketClientAdapter(parserFactory, this.outputType, ctx, partition, socket.second, directorySplits[partition]);
    }
