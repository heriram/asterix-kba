...
public class KBAStreamProcessor {
    ...
    private void writeKBAStreamDocString(KBAStreamDoc kbaStreamItem) throws IOException {
    ...
    public boolean setNextRecordBatch(int numStreamItemsInBatch) throws Exception {
        ...
        if (!moreData) {
            ...
            int count = 0;
            while (count < numStreamItemsInBatch) {
