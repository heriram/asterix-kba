...
public class KBAStreamSocketClientAdapterFactory implements IFeedAdapterFactory {
    ...
    public IDatasourceAdapter createAdapter(IHyracksTaskContext ctx, int partition) throws Exception {
        ...
        return new KBAStreamSocketClientAdapter(socket.second, directorySplits[partition], ctx);
    }
