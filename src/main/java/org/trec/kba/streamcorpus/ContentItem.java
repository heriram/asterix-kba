...
Cloneable {
    private static final TStruct STRUCT_DESC = new TStruct("ContentItem");
    ...
    private static final TField MEDIA_TYPE_FIELD_DESC = new TField("media_type", TType.STRING, (short) 3);
    private static final TField CLEAN_HTML_FIELD_DESC = new TField("clean_html", TType.STRING, (short) 4);
    private static final TField CLEAN_VISIBLE_FIELD_DESC = new TField("clean_visible", TType.STRING, (short) 5);
    private static final TField LOGS_FIELD_DESC = new TField("logs", TType.LIST, (short) 6);
    private static final TField TAGGINGS_FIELD_DESC = new TField("taggings", TType.MAP, (short) 7);
    private static final TField LABELS_FIELD_DESC = new TField("labels", TType.MAP, (short) 8);
    private static final TField SENTENCES_FIELD_DESC = new TField("sentences", TType.MAP, (short) 9);
    private static final TField SENTENCE_BLOBS_FIELD_DESC = new TField("sentence_blobs", TType.MAP, (short) 10);
    private static final TField LANGUAGE_FIELD_DESC = new TField("language", TType.STRUCT, (short) 11);
    private static final TField RELATIONS_FIELD_DESC = new TField("relations", TType.MAP, (short) 12);
    private static final TField ATTRIBUTES_FIELD_DESC = new TField("attributes", TType.MAP, (short) 13);
    private static final TField EXTERNAL_IDS_FIELD_DESC = new TField("external_ids", TType.MAP, (short) 14);
    ...
    private _Fields optionals[] = { _Fields.RAW, _Fields.ENCODING, _Fields.MEDIA_TYPE, _Fields.CLEAN_HTML,
            _Fields.CLEAN_VISIBLE, _Fields.LOGS, _Fields.TAGGINGS, _Fields.LABELS, _Fields.SENTENCES,
            _Fields.SENTENCE_BLOBS, _Fields.LANGUAGE, _Fields.RELATIONS, _Fields.ATTRIBUTES, _Fields.EXTERNAL_IDS };
    ...
    static {
        ...
        tmpMap.put(_Fields.LOGS, new org.apache.thrift.meta_data.FieldMetaData("logs",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.ListMetaData(
                        TType.LIST, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING))));
        tmpMap.put(_Fields.TAGGINGS, new org.apache.thrift.meta_data.FieldMetaData("taggings",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.StructMetaData(TType.STRUCT, Tagging.class))));
        tmpMap.put(_Fields.LABELS, new org.apache.thrift.meta_data.FieldMetaData("labels",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        ...
                        new org.apache.thrift.meta_data.ListMetaData(TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(TType.STRUCT, Label.class)))));
        tmpMap.put(_Fields.SENTENCES, new org.apache.thrift.meta_data.FieldMetaData("sentences",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.ListMetaData(TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(TType.STRUCT, Sentence.class)))));
        tmpMap.put(_Fields.SENTENCE_BLOBS, new org.apache.thrift.meta_data.FieldMetaData("sentence_blobs",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, true))));
        tmpMap.put(_Fields.LANGUAGE, new org.apache.thrift.meta_data.FieldMetaData("language",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.StructMetaData(
                        TType.STRUCT, Language.class)));
        tmpMap.put(_Fields.RELATIONS, new org.apache.thrift.meta_data.FieldMetaData("relations",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.ListMetaData(TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(TType.STRUCT, Relation.class)))));
        tmpMap.put(_Fields.ATTRIBUTES, new org.apache.thrift.meta_data.FieldMetaData("attributes",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.ListMetaData(TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(TType.STRUCT, Attribute.class)))));
        tmpMap.put(_Fields.EXTERNAL_IDS, new org.apache.thrift.meta_data.FieldMetaData("external_ids",
                org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.MapMetaData(
                        TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(TType.STRING, "TaggerID"),
                        new org.apache.thrift.meta_data.MapMetaData(TType.MAP,
                                new org.apache.thrift.meta_data.FieldValueMetaData(TType.I32, "MentionID"),
    ...
    public ContentItem(ContentItem other) {
        ...
        if (other.isSetSentence_blobs()) {
            ...
            for (Map.Entry<String, ByteBuffer> other_element : other.sentence_blobs.entrySet()) {
                ...
                ByteBuffer __this__sentence_blobs_copy_value = org.apache.thrift.TBaseHelper
        ...
        if (other.isSetExternal_ids()) {
            ...
            for (Map.Entry<String, Map<Integer, String>> other_element : other.external_ids.entrySet()) {
                ...
                for (Map.Entry<Integer, String> other_element_value_element : other_element_value.entrySet()) {
                    ...
                    __this__external_ids_copy_value.put(__this__external_ids_copy_value_copy_key,
                            __this__external_ids_copy_value_copy_value);
                }
    ...
    public void clear() {
        this.raw.clear();
        this.encoding = StreamItem.EMPTY_STRING;
        this.media_type = StreamItem.EMPTY_STRING;
        this.clean_html = StreamItem.EMPTY_STRING;
        this.clean_visible = StreamItem.EMPTY_STRING;
    ...
    private static class ContentItemStandardScheme extends StandardScheme<ContentItem> {
        ...
        @Override
        public void write(TProtocol oprot, ContentItem struct) throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.logs != null) {
                if (struct.isSetLogs()) {
                    ...
                    {
                        oprot.writeListBegin(new TList(TType.STRING, struct.logs.size()));
            ...
            if (struct.taggings != null) {
                if (struct.isSetTaggings()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, struct.taggings.size()));
            ...
            if (struct.labels != null) {
                if (struct.isSetLabels()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.LIST, struct.labels.size()));
            ...
            if (struct.sentences != null) {
                if (struct.isSetSentences()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.LIST, struct.sentences.size()));
                        for (Map.Entry<String, List<Sentence>> _iter115 : struct.sentences.entrySet()) {
                            oprot.writeString(_iter115.getKey());
                            {
                                oprot.writeListBegin(new TList(TType.STRUCT, _iter115.getValue().size()));
            ...
            if (struct.sentence_blobs != null) {
                if (struct.isSetSentence_blobs()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, struct.sentence_blobs.size()));
            ...
            if (struct.relations != null) {
                if (struct.isSetRelations()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.LIST, struct.relations.size()));
            ...
            if (struct.attributes != null) {
                if (struct.isSetAttributes()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.LIST, struct.attributes.size()));
                        for (Map.Entry<String, List<Attribute>> _iter120 : struct.attributes.entrySet()) {
                            oprot.writeString(_iter120.getKey());
                            {
                                oprot.writeListBegin(new TList(TType.STRUCT, _iter120.getValue().size()));
            ...
            if (struct.external_ids != null) {
                if (struct.isSetExternal_ids()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.MAP, struct.external_ids.size()));
                        for (Map.Entry<String, Map<Integer, String>> _iter122 : struct.external_ids.entrySet()) {
                            oprot.writeString(_iter122.getKey());
                            {
                                oprot.writeMapBegin(new TMap(TType.I32, TType.STRING, _iter122.getValue().size()));
    ...
    private static class ContentItemTupleScheme extends TupleScheme<ContentItem> {
        ...
        @Override
        public void write(TProtocol prot, ContentItem struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(TProtocol prot, ContentItem struct) throws org.apache.thrift.TException {
            ...
            if (incoming.get(5)) {
                {
                    TList _list137 = new TList(TType.STRING, iprot.readI32());
            ...
            if (incoming.get(6)) {
                {
                    TMap _map140 = new TMap(TType.STRING, TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(7)) {
                {
                    TMap _map144 = new TMap(TType.STRING, TType.LIST, iprot.readI32());
                    ...
                    for (int _i145 = 0; _i145 < _map144.size; ++_i145) {
                        ...
                        {
                            TList _list148 = new TList(TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(8)) {
                {
                    TMap _map151 = new TMap(TType.STRING, TType.LIST, iprot.readI32());
                    ...
                    for (int _i152 = 0; _i152 < _map151.size; ++_i152) {
                        ...
                        {
                            TList _list155 = new TList(TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(9)) {
                {
                    TMap _map158 = new TMap(TType.STRING, TType.STRING, iprot.readI32());
            ...
            if (incoming.get(11)) {
                {
                    TMap _map162 = new TMap(TType.STRING, TType.LIST, iprot.readI32());
                    ...
                    for (int _i163 = 0; _i163 < _map162.size; ++_i163) {
                        ...
                        {
                            TList _list166 = new TList(TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(12)) {
                {
                    TMap _map169 = new TMap(TType.STRING, TType.LIST, iprot.readI32());
                    ...
                    for (int _i170 = 0; _i170 < _map169.size; ++_i170) {
                        ...
                        {
                            TList _list173 = new TList(TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(13)) {
                {
                    TMap _map176 = new TMap(TType.STRING, TType.MAP, iprot.readI32());
                    ...
                    for (int _i177 = 0; _i177 < _map176.size; ++_i177) {
                        ...
                        {
                            TMap _map180 = new TMap(TType.I32, TType.STRING, iprot.readI32());
