 ...
 */
public class StreamItem implements org.apache.thrift.TBase<StreamItem, StreamItem._Fields>, Serializable, Cloneable {
    ...
    private static final TStruct STRUCT_DESC = new TStruct("StreamItem");

    private static final TField VERSION_FIELD_DESC = new TField("version", TType.I32, (short) 1);
    private static final TField DOC_ID_FIELD_DESC = new TField("doc_id", TType.STRING, (short) 2);
    private static final TField ABS_URL_FIELD_DESC = new TField("abs_url", TType.STRING, (short) 3);
    private static final TField SCHOST_FIELD_DESC = new TField("schost", TType.STRING, (short) 4);
    private static final TField ORIGINAL_URL_FIELD_DESC = new TField("original_url", TType.STRING, (short) 5);
    private static final TField SOURCE_FIELD_DESC = new TField("source", TType.STRING, (short) 6);
    private static final TField BODY_FIELD_DESC = new TField("body", TType.STRUCT, (short) 7);
    private static final TField SOURCE_METADATA_FIELD_DESC = new TField("source_metadata", TType.MAP, (short) 8);
    private static final TField STREAM_ID_FIELD_DESC = new TField("stream_id", TType.STRING, (short) 9);
    private static final TField STREAM_TIME_FIELD_DESC = new TField("stream_time", TType.STRUCT, (short) 10);
    private static final TField OTHER_CONTENT_FIELD_DESC = new TField("other_content", TType.MAP, (short) 11);
    private static final TField RATINGS_FIELD_DESC = new TField("ratings", TType.MAP, (short) 12);
    ...
    public StreamItem() {
        this.version = org.trec.kba.streamcorpus.Versions.v0_3_0;
    ...
    private void clearOtherContent() {
        if (this.other_content == null) {
            return;
        }
        for (ContentItem ci : this.other_content.values()) {
            ci.clear();
        }
    }
    ...
    public void clear() {
        ...
        this.doc_id = EMPTY_STRING;

        if (this.abs_url != null) {
            this.abs_url.clear();
        }

        this.schost = EMPTY_STRING;

        if (this.original_url != null) {
            this.original_url.clear();
        }
        ...
        this.stream_id = EMPTY_STRING;

        if (this.stream_time != null) {
            this.stream_time.clear();
        }
    ...
    private static class StreamItemStandardSchemeFactory implements SchemeFactory {
        ...
        public StreamItemStandardScheme getScheme() {
            return StreamItemStandardScheme.INSTANCE;
        }
    }
    ...
    private static class StreamItemStandardScheme extends StandardScheme<StreamItem> {
        ...
        @Override
        public void write(TProtocol oprot, StreamItem struct) throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.source_metadata != null) {
                if (struct.isSetSource_metadata()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, struct.source_metadata.size()));
            ...
            if (struct.other_content != null) {
                if (struct.isSetOther_content()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, struct.other_content.size()));
            ...
            if (struct.ratings != null) {
                if (struct.isSetRatings()) {
                    ...
                    {
                        oprot.writeMapBegin(new TMap(TType.STRING, TType.LIST, struct.ratings.size()));
                        for (Map.Entry<String, List<Rating>> _iter209 : struct.ratings.entrySet()) {
                            oprot.writeString(_iter209.getKey());
                            {
                                oprot.writeListBegin(new TList(TType.STRUCT, _iter209.getValue().size()));
    ...
    private static class StreamItemTupleScheme extends TupleScheme<StreamItem> {
        ...
        @Override
        public void write(TProtocol prot, StreamItem struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(TProtocol prot, StreamItem struct) throws org.apache.thrift.TException {
            ...
            if (incoming.get(7)) {
                {
                    TMap _map215 = new TMap(TType.STRING, TType.STRING, iprot.readI32());
            ...
            if (incoming.get(10)) {
                {
                    TMap _map219 = new TMap(TType.STRING, TType.STRUCT, iprot.readI32());
            ...
            if (incoming.get(11)) {
                {
                    TMap _map223 = new TMap(TType.STRING, TType.LIST, iprot.readI32());
                    ...
                    for (int _i224 = 0; _i224 < _map223.size; ++_i224) {
                        ...
                        {
                            TList _list227 = new TList(TType.STRUCT, iprot.readI32());
